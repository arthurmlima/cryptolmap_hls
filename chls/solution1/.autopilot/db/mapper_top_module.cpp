...
auto* soutput_stream_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_dest_V);
  // DUT call
  top_module(sinput_stream_V_data_V->data<long long>(), sinput_stream_V_keep_V->data<char>(), sinput_stream_V_strb_V->data<char>(), sinput_stream_V_user_V->data<char>(), sinput_stream_V_last_V->data<char>(), sinput_stream_V_id_V->data<char>(), sinput_stream_V_dest_V->data<char>(), soutput_stream_V_data_V->data<long long>(), soutput_stream_V_keep_V->data<char>(), soutput_stream_V_strb_V->data<char>(), soutput_stream_V_user_V->data<char>(), soutput_stream_V_last_V->data<char>(), soutput_stream_V_id_V->data<char>(), soutput_stream_V_dest_V->data<char>(), __xlx_apatb_param_u_perm, __xlx_apatb_param_u_diff, __xlx_apatb_param_u_dt);
sinput_stream_V_data_V->transfer((hls::stream<long long>*)__xlx_apatb_param_input_stream_V_data_V);
