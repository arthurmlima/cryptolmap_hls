...
set id 131
set name top_module_mux_64_6_32_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_w_strm \
    op interface \
    ports { w_strm_dout { I 32 vector } w_strm_num_data_valid { I 6 vector } w_strm_fifo_cap { I 6 vector } w_strm_empty_n { I 1 bit } w_strm_read { O 1 bit } } \
} "
}
