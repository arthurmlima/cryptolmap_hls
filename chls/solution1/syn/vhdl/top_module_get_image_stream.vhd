...
attribute shreg_extract : string;
    ...
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_done : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_idle : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_ready : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_msg_strm_din : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_msg_strm_write : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_input_stream_TREADY : STD_LOGIC;
    signal grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg : STD_LOGIC := '0';
    ...
    component top_module_get_image_stream_Pipeline_VITIS_LOOP_16_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71 : component top_module_get_image_stream_Pipeline_VITIS_LOOP_16_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_ready = ap_const_logic_1)) then 
                    grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, len_strm_full_n, end_len_strm_full_n, ap_CS_fsm_state4, ap_CS_fsm_state5, grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_done)
    begin
        if ((grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_done = ap_const_logic_0)) then 
    ...
    grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start <= grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_ap_start_reg;
    input_stream_TREADY <= regslice_both_input_stream_V_data_V_U_ack_in;

    input_stream_TREADY_int_regslice_assign_proc : process(grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_input_stream_TREADY, ap_CS_fsm_state3)
    begin
    ...
    msg_strm_write_assign_proc : process(grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_msg_strm_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            msg_strm_write <= grp_get_image_stream_Pipeline_VITIS_LOOP_16_1_fu_71_msg_strm_write;
        else 
