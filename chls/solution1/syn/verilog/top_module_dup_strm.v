...
top_module_dup_strm_Pipeline_VITIS_LOOP_506_1 grp_dup_strm_Pipeline_VITIS_LOOP_506_1_fu_62(
    ...
    .nblk_strm1_num_data_valid(6'd0),
    .nblk_strm1_fifo_cap(6'd0),
    ...
    .end_nblk_strm1_num_data_valid(6'd0),
    .end_nblk_strm1_fifo_cap(6'd0),
    ...
    .nblk_strm2_num_data_valid(6'd0),
    .nblk_strm2_fifo_cap(6'd0),
    ...
    .end_nblk_strm2_num_data_valid(6'd0),
    .end_nblk_strm2_fifo_cap(6'd0),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((end_nblk_strm2_full_n == 1'b0) | (end_nblk_strm1_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((end_nblk_strm_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        e_reg_79 <= end_nblk_strm_dout;
    end
end

always @ (*) begin
    if (((end_nblk_strm_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0))) begin
...
always @ (*) begin
    if (((end_nblk_strm2_full_n == 1'b0) | (end_nblk_strm1_full_n == 1'b0))) begin
...
always @ (*) begin
    if ((~((end_nblk_strm2_full_n == 1'b0) | (end_nblk_strm1_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
