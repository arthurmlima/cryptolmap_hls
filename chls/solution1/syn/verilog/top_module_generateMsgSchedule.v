...
reg   [31:0] blk_reg_625;
reg   [31:0] blk_15_reg_630;
reg   [31:0] blk_14_reg_635;
reg   [31:0] blk_1_reg_640;
reg   [31:0] blk_2_reg_645;
reg   [31:0] blk_3_reg_650;
reg   [31:0] blk_4_reg_655;
reg   [31:0] blk_5_reg_660;
reg   [31:0] blk_6_reg_665;
reg   [31:0] blk_7_reg_670;
reg   [31:0] blk_8_reg_675;
reg   [31:0] blk_9_reg_680;
reg   [31:0] blk_13_reg_685;
reg   [31:0] blk_10_reg_690;
reg   [31:0] blk_11_reg_695;
reg   [31:0] blk_12_reg_700;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((e_4_reg_202 == 1'd0) & (nblk_strm1_empty_n == 1'b0)) & (ap_phi_mux_e_4_phi_fu_205_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_generateMsgSchedule_Pipeline_LOOP_SHA256_PREPARE_WT64_fu_260_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
        i_reg_211 <= i_11_reg_620;
    end else if ((~((e_4_reg_202 == 1'd0) & (nblk_strm1_empty_n == 1'b0)) & (e_4_reg_202 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_211 <= 64'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0))) & (icmp_ln530_fu_282_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        blk_10_reg_690 <= {{blk_strm_dout[383:352]}};
        blk_11_reg_695 <= {{blk_strm_dout[415:384]}};
        blk_12_reg_700 <= {{blk_strm_dout[447:416]}};
        blk_13_reg_685 <= {{blk_strm_dout[351:320]}};
        blk_14_reg_635 <= {{blk_strm_dout[511:480]}};
        blk_15_reg_630 <= {{blk_strm_dout[479:448]}};
        blk_1_reg_640 <= {{blk_strm_dout[63:32]}};
        blk_2_reg_645 <= {{blk_strm_dout[95:64]}};
        blk_3_reg_650 <= {{blk_strm_dout[127:96]}};
        blk_4_reg_655 <= {{blk_strm_dout[159:128]}};
        blk_5_reg_660 <= {{blk_strm_dout[191:160]}};
        blk_6_reg_665 <= {{blk_strm_dout[223:192]}};
        blk_7_reg_670 <= {{blk_strm_dout[255:224]}};
        blk_8_reg_675 <= {{blk_strm_dout[287:256]}};
        blk_9_reg_680 <= {{blk_strm_dout[319:288]}};
        blk_reg_625 <= blk_fu_293_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((~((end_nblk_strm1_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1)) | (~(((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0))) & (icmp_ln530_fu_282_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3)))) begin
        e_4_reg_202 <= end_nblk_strm1_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state3))) begin
        i_11_reg_620 <= i_11_fu_287_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((e_4_reg_202 == 1'd0) & (nblk_strm1_empty_n == 1'b0)) & (e_4_reg_202 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        n_reg_612 <= nblk_strm1_dout;
    end
end

always @ (*) begin
    if (((end_nblk_strm1_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0))) begin
...
always @ (*) begin
    if (((e_4_reg_202 == 1'd0) & (nblk_strm1_empty_n == 1'b0))) begin
...
always @ (*) begin
    if ((((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0)))) begin
...
always @ (*) begin
    if ((~((e_4_reg_202 == 1'd0) & (nblk_strm1_empty_n == 1'b0)) & (ap_phi_mux_e_4_phi_fu_205_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((end_nblk_strm1_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_state3 : begin
            if ((~(((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0))) & (icmp_ln530_fu_282_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~(((icmp_ln530_fu_282_p2 == 1'd1) & (end_nblk_strm1_empty_n == 1'b0)) | ((icmp_ln530_fu_282_p2 == 1'd0) & (blk_strm_empty_n == 1'b0))) & (icmp_ln530_fu_282_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
